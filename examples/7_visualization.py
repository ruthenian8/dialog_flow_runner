...
stats = Stats(
    saver=Saver("csv:///home/milty/Documents/dialog_flow_runner/examples/test_stats.csv"),
    collectors=[DSC.NodeLabelCollector()]
)

actor = stats.update_actor_handlers(actor, auto_save=False)
...
if __name__ == "__main__":
    try:
        ...
        StreamlitDashboard(stats.dataframe)()
